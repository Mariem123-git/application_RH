...
def run(df):
    ...
    with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
        ...
        # Statistiques indemnités (si disponibles)
        if not df_stats.empty:
            df_stats.to_excel(writer, sheet_name='Statistiques indemnités', index=False)
    ...
    st.download_button(
        ...
        data=output,
        file_name="indemnites_et_voitures_rapport.xlsx",
